...
Elm.MakeAd.make = function (elm)
                  {
                    ...
                    var adUrl = function ()
                                {
                                  ...
                                  return Utils.Rest.singleGet(A2(Signal.sampleOn,
                                                                 function (_)
                                                                 {
                                                                   return _.butn;
                                                                 }(Components.UserInput.presentRec),
                    ...
                    elm.MakeAd.values = {_op: _op, isbnUrl: isbnUrl, isbnPreview: isbnPreview, adUrl: adUrl, extractor: extractor, display: display, main: main};
                    return elm.MakeAd.values;
...
Elm.Components.UserInput.make = function (elm)
                                {
                                  ...
                                  Utils.Layout = Elm.Utils.Layout.make(elm);
                                  var _op = {};
                                  var validSigRecord = {_: {}, butn: "", expire: "", isbn: "", price: ""};
                                  var tableS = function ()
                                               {
                                  ...
                                  var buyBtn = Graphics.Element.link("/Utils/Confirmation.html")(Utils.Layout.buttonGen("buy"));
                                  ...
                                  elm.Components.UserInput.values = {_op: _op, isbnField: isbnField, isbnSignal: isbnSignal, priceField: priceField, priceSignal: priceSignal, expireField: expireField, expireSignal: expireSignal, buyBtn: buyBtn, sellBtn: sellBtn, buySell: buySell, validSigRecord: validSigRecord, whatsNew: whatsNew, presentRec: presentRec, validSignals: validSignals, preview: preview, adMaker: adMaker, flombine: flombine, tableS: tableS};
                                  return elm.Components.UserInput.values;
                                };Elm.Utils = Elm.Utils || {};
...
Elm.Utils.Valid.make = function (elm)
                       {
                         ...
                         elm.Utils.Valid.values = {_op: _op, isbn: isbn, price: price, expire: expire, butn: butn};
                         return elm.Utils.Valid.values;
                       };