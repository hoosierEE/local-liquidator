...
url = "/php/storeAd.php?Title=&ISBN10=1234567890&ISBN13=123456789abc&imageURL=someImgUrl&ExpTime=later&Description=Short&Condition=new&Price=12.42&user=ashroyer&Adtype=seller&Lat=1&Lon=2" 
...
-- display
note = width 100 . plainText <| "click to post the URL to " ++ url 
